    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ViewProjects.useEffect": ()=>{
            const interval = setInterval({
                "ViewProjects.useEffect.interval": ()=>{
                    setCurrent({
                        "ViewProjects.useEffect.interval": (prev)=>(prev + 1) % projects.length
                    }["ViewProjects.useEffect.interval"]);
                }
            }["ViewProjects.useEffect.interval"], 10000);
            return ({
                "ViewProjects.useEffect": ()=>clearInterval(interval)
            })["ViewProjects.useEffect"];
        }
    }["ViewProjects.useEffect"], []);
    const handlePrev = ()=>{
...
_s(ViewProjects, "Ce5S7Zpl2S4YgGoPn+G4m52qKq8=");
_c = ViewProjects;
var _c;
...
//# sourceMappingURL=_247914bb._.js.map